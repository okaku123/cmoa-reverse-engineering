...
export default function ClipScreen(props) {
    ...
    function saveResult() {
        ...
        for (let i = 0; i < 8; i++) {
            const horizontalClipLine = document.body.querySelector(`#horizontalClipLine-${i}`)
            result.horizontal.push(horizontalClipLine.getBoundingClientRect().top)
            const verticalClipLine = document.body.querySelector(`#verticalClipLine-${i}`)
            ...
            <div className='container-full w-full  bg-base-100 overflow-scroll'>
                ...
                <div className='w-full flex justify-end'>
                    ...
                    <div className='w-44 flex justify-end flex-col '>
                        ...
                        <label className='btn btn-sm btn-primary mx-5'
                            onClick={e => {
