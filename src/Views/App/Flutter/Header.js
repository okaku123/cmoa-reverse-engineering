...
export default function Header(props) {
  const { currentPage, setCurrentPage, saveList } = props;
  ...
  return (
    <>
      <div className="navbar w-full bg-base-100 flex justify-between items-center">
        ...
        <div className="navbar-center">
          <div role="tablist" className="tabs tabs-boxed">
            <a
              role="tab"
              className={currentPage == "0" ? "tab tab-active" : "tab"}
            ...
            <a
              role="tab"
              className={currentPage == "1" ? "tab tab-active" : "tab"}
            ...
            <a
              role="tab"
              className={currentPage == "2" ? "tab tab-active" : "tab"}
      ...
      <div className="navbar w-full bg-base-100  flex flex-col justify-start items-start">
        <label className="btn btn-sm btn-ghost " onClick={() => {}}>
